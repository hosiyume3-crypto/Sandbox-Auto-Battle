...
function initLibraries() {
    ...
    actionLibrary = [
        // --- 新規遠距離: スーパーボール ---
        A("super_ball", "スーパーボール", "Ranged", "RANGE", "PROJECTILE", 999, 30, 300, 420, "LEGENDARY", "6方向に発射。壁と敵で跳ね返る。"),
        ...
        A("alchemy", "錬金術", "Magic", "AOE", "DEBUFF", 200, 15, 40, 480, "RARE", "毒霧。撃破時ポーション生成。"),
        ...
        A("ragnarok", "ラグナロク", "Melee", "MELEE", "ATK", 50, 56, 60, 480, "LEGENDARY", "対象を爆破し、全画面落雷。"),
        ...
        A("flame", "ファイア", "Magic", "RANGE", "PROJECTILE", 120, 5, 10, 5, "COMMON", "射程の短い連射炎。"),
    ...
    actionLibrary.push(M("move_kite", "カイト", "敵と一定距離を保つ。", "#0d0"));
